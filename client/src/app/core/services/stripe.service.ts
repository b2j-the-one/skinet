...
export class StripeService {
  ...
  /**
   * Créer le token de confirmation du paiement
   *
   * @returns Le token de confirmation du paiement
   */
   ...
   *
   * @param confirmationToken Le token de confirmation
   * @returns La confirmation de paiement
   */
